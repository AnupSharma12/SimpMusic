...
import com.anup.auvro.service.backup.AutoBackupScheduler
...
import org.auvro.crashlytics.configCrashlytics
import java.lang.reflect.Field

class AuvroApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@AuvroApplication)
            loadAllModules()
