...
fun ReviewDialog(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = {
                onDoneReview.invoke()
                uriHandler.openUri("https://github.com/AnupSharma12/Auvro")
            }) {
                Text(
        ...
        text = {
            Text(
                buildAnnotatedString {
                    ...
                    withLink(
                        LinkAnnotation.Url(
                            "https://www.producthunt.com/products/auvro",
                            TextLinkStyles(style = SpanStyle(textDecoration = TextDecoration.Underline, color = seed)),
                        ) {
                            onDoneReview.invoke()
                            onDismissRequest.invoke()
                            uriHandler.openUri("https://www.producthunt.com/products/auvro")
                        },
                    ) {
                        append(" ProductHunt")
                    }
                    ...
                    withLink(
                        LinkAnnotation.Url(
                            "https://buymeacoffee.com/anup",
                            TextLinkStyles(style = SpanStyle(textDecoration = TextDecoration.Underline, color = seed)),
                        ) {
                            onDoneReview.invoke()
                            onDismissRequest.invoke()
                            uriHandler.openUri("https://buymeacoffee.com/anup")
                        },
                    ) {
