package com.anup.auvro.ui.screen.login
...
import com.anup.auvro.expect.ui.PlatformWebView
import com.anup.auvro.expect.ui.createWebViewCookieManager
import com.anup.auvro.expect.ui.rememberWebViewState
import com.anup.auvro.ui.component.DevLogInBottomSheet
import com.anup.auvro.ui.component.DevLogInType
...
import auvro.composeapp.generated.resources.log_in
import auvro.composeapp.generated.resources.login_failed
import auvro.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.anup.auvro.expect.ui.WebViewState.Finished -> "Finished"
                        is com.anup.auvro.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
